...
{
    m_diagnostics
        .emplace_back(Range{10, 10}, DiagnosticSeverity::ERROR, typeid(*this).name(), "First ERROR message");
    m_diagnostics
        .emplace_back(Range{20, 10}, DiagnosticSeverity::ERROR, typeid(*this).name(), "Second ERROR message");
    m_diagnostics
...
{
    m_diagnostics.emplace_back(Range{40, 10},
...
{
    m_diagnostics
        .emplace_back(Range{70, 10}, DiagnosticSeverity::HINT, typeid(*this).name(), "First HINT message");
    m_diagnostics
        .emplace_back(Range{80, 10}, DiagnosticSeverity::HINT, typeid(*this).name(), "Second HINT message");
    m_diagnostics
...
{
    m_diagnostics.emplace_back(Range{100, 10},
